  ...
  return (
    <div class="flex items-end w-full  bg-white">
      <footer class="w-full text-gray-700 bg-gray-100 body-font">
        <div
          class="container flex flex-col flex-wrap px-5 py-32 mx-auto md:items-center lg:items-start md:flex-row md:flex-no-wrap">
          <div class="flex-shrink-0 w-64 mx-auto text-center md:mx-0 md:text-left">
         
            <p class="mt-2 text-sm text-gray-500">Learn with us</p>
            <div class="mt-4">
        ...
        <div class="bg-gray-300">
          <div class="container px-5 py-4 mx-auto flex justify-center">
